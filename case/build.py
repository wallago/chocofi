...
import nice_nano_model
import nice_view_model
...
from nice_nano_model import import_nice_nano
from nice_view_model import build_nice_view
...
parts = [
    ...
    ("Nice_View", build_nice_view, (0.85, 0.90, 0.20), 0),
]
